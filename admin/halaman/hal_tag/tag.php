...
session_start();
 if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])){
  ...
  echo "
  <link href='zalstyle.css' rel='stylesheet' type='text/css'>";
...
$aksi="halaman/hal_tag/aksi_tag.php";
switch($_GET[act]){
//update/////////////////////////////////////
...
echo "<div id=main-content> 
      ...
      <div class=grid_12> 
      <br/>
   <a href='?halamane=tag&act=tambahtag' class='button'>
   <span>Tambahkan Spesifikasi</span>
   </a></div>";
...
echo "   <div class='grid_12'>
  ...
  <a href=?halamane=tag&act=edittag&id=$r[id_tag] title='Edit' class='with-tip'>
  <center><img src='img/edit.png'></a>
   
  <a href=javascript:confirmdelete('$aksi?halamane=tag&act=hapus&id=$r[id_tag]') title='Hapus' class='with-tip'>
...
//batas update/////////////////////////////////////////////////////////////////////////
   ...
   <form method=POST action='$aksi?halamane=tag&act=input'>
   
   <p class=inline-small-label> 
   <label for=field4>Nama Spesifikasi</label>
   <input type=text name='nama_tag' SIZE=30>
      ...
      <li>
      <a class='button red' id=reset-validate-form href='?halamane=tag'>Batal</a>
      </li> </ul>
 ...
 echo "
   ...
   <form method=POST action=$aksi?halamane=tag&act=update>
