...
$aksi="halaman/hal_logo/aksi_logo.php";
switch($_GET[act]){
  // Tampil logo
  default:
  ...
  <a href=?halamane=logo&act=editlogo&id=$r[id_logo] title='Edit' class='with-tip'>
  ...
  echo "
   ...
   <form method=POST enctype='multipart/form-data' action=$aksi?halamane=logo&act=update>
   ...
   <li>
   <a class='button red' id=reset-validate-form href='?halamane=logo'>Batal</a>
   </li> </ul>
