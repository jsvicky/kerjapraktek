<?php
session_start();
$image_path = "../../../logo/sigit_marking.png";
$font_path = "RIZAL.TTF";
$font_size = 14;       // in pixcels
//$water_mark_text_1 = "9";
$water_mark_text_2 = "Sixghakreasi";
...
// Hapus gallery
if ($halamane=='galerifoto' AND $act=='hapus'){
...
// Input gallery
elseif ($halamane=='galerifoto' AND $act=='input'){
...
// Update gallery
elseif ($halamane=='galerifoto' AND $act=='update'){
  $lokasi_file    = $_FILES['fupload']['tmp_name'];
  $tipe_file      = $_FILES['fupload']['type'];
  $nama_file      = $_FILES['fupload']['name'];
  $acak           = rand(1,99);
