  ...
  <th>Aksi</th>
   ...
   <tbody>";
    ...
    echo "<tr class=gradeX> 
	  ...
	  <td><b>$r[nama]</b></td>
	  <td><b><a href=?halamane=hubungi&act=balasemail&id=$r[id_hubungi]>$r[email]</a></b></td>
	  <td><b>$r[subjek]</b></td>
	  <td><b>$tgl</a></b></td>
	  
      <td width=80>
	 <a href=?halamane=hubungi&act=balasemail&id=$r[id_hubungi] title='Baca' class='with-tip'>
     <center><img src='img/edit.png'></a>
   
    <a href=javascript:confirmdelete('$aksi?halamane=hubungi&act=hapus&id=$r[id_hubungi]') 
...
echo "<tr class=gradeX> 
  ...
  $r[pesan]</textarea>
     ...
     <div class=block-actions> 
      ...
      <li>
      <a class='button red' id=reset-validate-form href='?halamane=hubungi'>Batal</a>
      </li> </ul>
...
"Content-type: text/html; charset=iso-8859-1";
   ...
   <ul class=actions-right> 
   <li>
   <a class='button red' id=reset-validate-form href='?halamane=hubungi'>Kembali</a>
   </li> </ul>
   </form>";
