...
echo "<div id=main-content> 
      ...
      <div class=grid_12> 
      <br/>
	  <a href='?halamane=kategori&act=tambahkategori' class='button'>
...
echo "<div class=grid_12> 
  ...
  <a href=?halamane=kategori&act=editkategori&id=$r[id_kategori] title='Edit' class='with-tip'>
  <center><img src='img/edit.png'></a>
   
  <a href=javascript:confirmdelete('$aksi?halamane=kategori&act=hapus&id=$r[id_kategori]') title='Hapus' class='with-tip'>
...
//batas update/////////////////////////////////////////////////////////////////////////
  ...
  echo "
   ...
   <form id='login' method=POST action='$aksi?halamane=kategori&act=input'>
		  
   <p class=inline-small-label> 
   <label for=field4>Nama Kategori</label>
   <input type=text name='nama_kategori' class='required' title='Nama Kategori harus di isi'>
   </p> 
      ...
      <li>
      <a class='button red' id=reset-validate-form href='?halamane=kategori'>Batal</a>
      </li> </ul>
  ...
  echo "
   ...
   <form method=POST action=$aksi?halamane=kategori&act=update>
